...
export default function Loading() { return ( <> <section className="relative h-banner-mobile xl:h-banner-desktop"> <div className="absolute inset-0 w-full h-full bg-black dark:bg-gray-950"> <Skeleton className="w-full h-full" /> </div> <div className="absolute inset-0 flex flex-col px-10 md:px-36 xl:px-72 pt-10 md:pt-36 xl:justify-center text-white"> <Skeleton className="w-40 h-10 mb-2" /> <Skeleton className="w-40 h-10 mb-2" /> <Skeleton className="w-40 h-10" /> <Skeleton className="mt-4 w-80 h-6" /> <Skeleton className="mt-6 w-40 h-10 rounded-xl" /> </div> </section>
